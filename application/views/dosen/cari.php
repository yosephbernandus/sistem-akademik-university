...
<Table class="table table-striped">
    ...
    <tr>
        ...
        <td><a href="<?php echo site_url('dosen/edit/'.$row->nid);?>"><i class="glyphicon glyphicon-edit"></i></a></td>
        <td><a href="#" class="hapus" kode="<?php echo $row->nid;?>"><i class="glyphicon glyphicon-trash"></i></a></td>
    </tr>
    <?php endforeach;?>
</Table>
