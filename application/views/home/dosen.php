    	 	...
    	 	<div class="container">
    	 		...
    	 		<div class="navbar-collapse collapse">
    	 			...
    	 			<div class="nav navbar-nav navbar-right">
    	 				<form class="navbar-form navbar-left" role="search" action="<?php echo site_url('home/cari_dosen');?>" method="post">
    	 					<div class="form-group">
    	 						<input type="text" name="cari" class="form-control" placeholder="Cari Dosen">
    	 					</div>
